...
export class CustomerService {
  ...
  private baseUrl = 'https://localhost:7127/api/';

  private baseurl1 = 'https://localhost:7127/api/';
  
  private baseUrl2 = 'https://localhost:7127/api/';
  ...
  addCarDetails(car: any): Observable<any> {
    ...
    let url = this.baseurl1 + 'CarDetails/getcardetails';
